...
public class teacherr extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        class_count = new javax.swing.JTextField();
        ...
        jLabel21.setText("Class Count     :");

        class_count.setForeground(new java.awt.Color(102, 102, 102));
        class_count.setText("Class Count");
        class_count.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                class_countFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                class_countFocusLost(evt);
            }
        });
        class_count.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                class_countActionPerformed(evt);
            }
        });
        class_count.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                class_countKeyTyped(evt);
            }
        });
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(salary, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)
                                    .addComponent(password, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)
                                    .addComponent(address, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)
                                    .addComponent(phone, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)
                                    .addComponent(email, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)
                                    .addComponent(id, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)
                                    .addComponent(name, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(jLabel21, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(class_count, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(146, 146, 146)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(class_count, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30)
...
// TODO add your handling code here:
   ...
   System.exit(0);    }//GEN-LAST:event_jLabel20MouseClicked
    ...
    private void class_countFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_class_countFocusGained
        if (class_count.getText().equals("Class Count")) {
            class_count.setText("");
            class_count.setForeground(new Color(0, 0, 0));
        }
        class_count.setFont(class_count.getFont().deriveFont(Font.BOLD, 14f));
        // TODO add your handling code here:
    }//GEN-LAST:event_class_countFocusGained


    private void class_countFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_class_countFocusLost
        if (class_count.getText().equals("")) {
            class_count.setText("Class Count");
            class_count.setForeground(new Color(153, 153, 153));
        }
        class_count.setFont(class_count.getFont().deriveFont(Font.PLAIN, 14f));
        // TODO add your handling code here:
    }//GEN-LAST:event_class_countFocusLost


    private void class_countActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_class_countActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_class_countActionPerformed
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        if (name.getText().equals("Enter Name") | name.getText().isEmpty()
                ...
                | class_count.getText().equals("Class Count") | class_count.getText().isEmpty()) {

            JOptionPane.showMessageDialog(null, "There are empty fields");
        } else {
            try {
                if (file.search_T_id(id.getText())) {
                    JOptionPane.showMessageDialog(null, "This id has been used");
                } else {

                    School.Add_teasher(name.getText(), class_count.getText(), id.getText(), address.getText(), phone.getText(), email.getText(), salary.getText(), password.getText());
                    this.dispose();
                    new Control().setVisible(true);
                }
            } catch (FileNotFoundException ex) {
                Logger.getLogger(teacherr.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
// TODO add your handling code here:
    ...
    private void class_countKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_class_countKeyTyped
        char c = evt.getKeyChar();
        if (!Character.isDigit(c)) {
            evt.consume();
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_class_countKeyTyped
...
// TODO add your handling code here:
    ...
    private javax.swing.JTextField class_count;
